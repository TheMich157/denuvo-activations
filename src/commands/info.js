...
export async function execute(interaction) {
  ...
  const welcomeEmbed = new EmbedBuilder()
    ...
    .setDescription([
      ...
      '• A **Steam Account** is required (you don\'t need to own the game)',
  ...
  const rulesEmbed = new EmbedBuilder()
    ...
    .setDescription([
      ...
      '7. 🎮 **Steam account required** — You need a Steam account to use the service, but you do not need to own the game.',
